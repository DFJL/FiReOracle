...
const GROUP_LABELS: Record<string, string> = {
  ...
  INVESTMENT_RETURN_CRYPTO: 'Ingreso pasivo',
  INVESTMENT_LIQUIDATION:   'Inversiones',
  APPRECIATION:             'Valorización',
  PASSIVE_INCOME:           'Ingreso pasivo',
  CRYPTO:                   'Ingreso pasivo',
  SAVINGS_INVESTMENT:       'Fondos de inversión',
  SAVINGS_INTEREST:         'Ingreso pasivo',
  SAVINGS:                  'Ahorro',
  SAVINGS_TRAVEL:           'Viajes',
  MISC_INCOME:              'Otros ingresos',
  PERSONAL_MARIAM:          'Mariam',
  PERSONAL_EMMA:            'Emma · Manutención',
  PERSONAL_SITA:            'Familia',
  LOANS:               'Préstamos',
...
export function displayCategory(code: string): string {
  const MAP: Record<string, string> = {
    ...
    INVESTMENT_RETURN_CRYPTO: 'Rendimientos cripto',
    INVESTMENT_LIQUIDATION:   'Liquidación inversión',
    APPRECIATION:             'Aumento de valor',
    PASSIVE_INCOME:           'Ingreso pasivo',
    CRYPTO:                   'Cripto',
    SAVINGS:                  'Ahorro',
    SAVINGS_INVESTMENT:       'Fondos de inversión',
    SAVINGS_INTEREST:         'Intereses y rendimientos',
    SAVINGS_TRAVEL:           'Viajes',
